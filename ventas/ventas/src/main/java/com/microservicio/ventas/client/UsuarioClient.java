package com.microservicio.ventas.client;
...
import com.microservicio.ventas.model.Usuario;
...
public class UsuarioClient {
    ...
    public UsuarioClient(WebClient.Builder builder, @Value("${registro-service.url}") String baseUrl) {
